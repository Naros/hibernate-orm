...
//	private static BasicTypeImpl<String> TextAsMaterializedClobType =
//			new BasicTypeImpl( StandardSpiBasicTypes.TEXT.getJavaTypeDescriptor(), ClobSqlDescriptor.DEFAULT );
//
//	@Override
