...
//		session.save( sim );
//		Query q = session.createNativeQuery( "select {sim.*} from Simple {sim} where {sim}.date_ = ?" ).addEntity( "sim", Simple.class );
//		q.setParameter( 0, sim.getDate() );
...
//		session.createNativeQuery( "select {simple.*} from Simple {simple}" ).addEntity( "simple", Simple.class ).list();
...
//				.addEntity( "category", Category.class );
//		unnamedParam.setParameter(0, "Good");
//		unnamedParam.setParameter(1, "Best");
...
//				.addEntity( "category", Category.class);
//		namedParam.setParameter("firstCat", "Better");
//		namedParam.setParameter("secondCat", "Best");
...
//        query.setParameter(0, "c64");
//        query.setParameter(1, "games");
//
